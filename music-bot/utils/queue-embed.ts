...
import { QueueEmbedOptions } from '../music-bot';
...
export class QueueEmbed extends MessageEmbed {
    ...
    public constructor(options: QueueEmbedOptions) {
        super({
            title: options.client.translate(['music', 'queue', 'title']),
            footer: {
                text: options.client.translate(['music', 'queue', 'footer']),
            },
        ...
        this.addField(
            this.client.translate(['music', 'queue', 'curPlaying']),
            '\u2000' + headSong,
            false,
        );
        ...
        if (queueSize > 1) {
            ...
            this.addField(
                this.client.translate(['music', 'queue', 'next']),
                sngs.length > 0
                    ? sngs.length > 1024
